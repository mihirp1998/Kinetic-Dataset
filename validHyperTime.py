...
def vid2img(i):
	...
	n+=1
	index = int(i[-8:-4])
	if(index>=240 and index<260):
		if os.path.isfile(i[:-8] + "0000.jpg") and os.path.isfile(i[:-8] + "0005.jpg") and os.path.isfile(i[:-8] + "0010.jpg"): 
			row = (i,i[:-8] + "0000.jpg",i[:-8] + "0005.jpg",i[:-8] + "0010.jpg")
			all_list.append(row)
		else:
...
import pickle
pickle.dump(all_list,open("240to260.p","wb"))
