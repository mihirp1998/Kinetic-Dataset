...
def vid2img(i):
	...
	n+=1
	i_strip = i.split("/")
	zero_file = i_strip[1][:index] + "_0.jpg"
	fifth_file = i_strip[1][:index] + "_5.jpg"
	tenth_file = i_strip[1][:index] + "_10.jpg"
...
import pickle
pickle.dump(all_list,open("trainHyperTuple100_mv.p","wb"))
